  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Custom Spring Blossoms Color Palette - Light Blue, Pink, Green & White
        'bloom': {
          'blue': {
            50: '#f0f9ff',   // Very light blue
            100: '#e0f2fe',  // Light blue
            200: '#bae6fd',  // Medium light blue
            300: '#7dd3fc',  // Light blue (primary tone)
          ...
          'pink': {
            ...
            300: '#f9a8d4',  // Light pink (secondary tone)
          ...
          'green': {
            ...
            300: '#86efac',  // Light green (accent tone)
